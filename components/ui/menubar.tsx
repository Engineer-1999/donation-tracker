...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      'flex h-10 items-center space-x-1 rounded-md  bg-white p-1 dark:bg-gray-950',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex cursor-pointer select-none items-center rounded-lg px-3 py-1.5 text-sm font-medium outline-none focus:bg-gray-100 focus:text-gray-900 data-[state=open]:bg-gray-100 data-[state=open]:text-gray-900 dark:focus:bg-gray-800 dark:focus:text-gray-50 dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-50',
      className,
    )}
    {...props}
  />
...
const MenubarShortcut = ({
  ...
  return (
    <span
      className={cn(
        'mr-auto text-xs tracking-widest text-gray-500 dark:text-gray-400',
        className,
      )}
      {...props}
    />
